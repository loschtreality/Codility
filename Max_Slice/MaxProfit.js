...
const maxProfit = (stocks) => {
  if (stocks.length <= 1) return stocks[0] || 0
  ...
  for (let day = 0, quarter = stocks.length; day < quarter; day++) {
    const price = stocks[day]
...
const array = [23171, 21011, 21123, 21355, 21013, 21367]
console.log(maxProfit(array)) // 356
